$code = [System.IO.File]::ReadAllText("C:\Users\KLH\New App\combined_desert_blender.py")
...
Write-Output "Sending desert environment to Blender (port 9876)..."
...
try {
    ...
    $stream.Flush()
    Write-Output "Sent! Waiting 60 seconds for Blender to generate the desert scene..."

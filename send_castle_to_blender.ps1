$code = [System.IO.File]::ReadAllText("C:\Users\KLH\New App\combined_castle_blender.py")
...
Write-Output "Sending European castle environment to Blender (port 9876)..."
...
try {
    ...
    $stream.Flush()
    Write-Output "Sent! Waiting 60 seconds for Blender to generate the castle scene..."
